                    ...
                    <div class="ctn">
                        ...
                        <div class="tab tab_4_2c">
                            <ul>
                                ...
                                <li class="active"><a href="/lawpro/www/domestic/domestic040102.jsp"><span>행정규칙</span></a></li>
                                <li><a href="/lawpro/www/domestic/domestic040103.jsp"><span>법령발표</span></a></li>
                                <li><a href="/lawpro/www/domestic/domestic040104.jsp"><span>행정규칙발표</span></a></li>
                            </ul>
                        </div>
                        <!-- 수정 -->
                        <!-- search_list -->
                                ...
                                <ul>
                                        ...
                                        <div class="l">
                                            <div class="tp">
                                                <strong class="ext_link">
                                                    <a href="#n" class="subj">제428호 법제처 자치법규에 대한 의견제시 업무 운영 규정</a>
                                                </strong>
                                            </div>
                                            <div class="bm">
                                                <ul>
                                    ...
                                    <li class="board_li">
                                        <div class="l">
                                            <div class="tp">
                                                <strong class="ext_link">
                                                    <a href="#n" class="subj">친환경농업직접지불 지급대상 농산물 등에 관한 고시</a>
                                                </strong>
                                            </div>
                                            <div class="bm">
                                                <ul>
                                    ...
                                    <li class="board_li">
                                        <div class="l">
                                            <div class="tp">
                                                <strong class="ext_link">
                                                    <a href="#n" class="subj">제2020-94호 대기업의 공공소프트웨어사업자 참여제한 예외사업</a>
                                                </strong>
                                            </div>
                                            <div class="bm">
                                                <ul>
