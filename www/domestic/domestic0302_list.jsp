            ...
            <div class="inner_ctr">
                ...
                <article id="content_area">
                    ...
                    <div class="ctn">
                        ...
                        <div class="intro">
                            의원입법예고 소식과 정부입법예고 소식을 제공합니다.
                            <ul>
                                <li>-  의원입법예고 : 국회입법에고 시스템의 진행중인 입법예고를 제공합니다.</li>
                                <li>-  정부입법예고 : 정부입법지원센터의 정부입법계획을 제공합니다.</li>
                            </ul>
                        </div>
                        <!-- search_form -->
                        ...
                        <div class="tab_area">
                            <div class="tab tab_3_3c">
                                <ul>
                                    ...
                                    <li><a href="#n"><span>의원입법예고</span></a></li>
                                    <li><a href="#n"><span>정부입법예고</span></a></li>
                                </ul>
                            </div>
                                            ...
                                            <ul>
                                                <li class="board_li single_link">
                                                    <div class="l">
                                                        <div class="tp">
                                                            <strong>
                                                                <span class="st font_col_blue">의원입법예고</span><a class="subj" href="/lawpro/www/domestic/domestic0302_view.jsp">주택임대차보호법 일부개정법률안 (맹성규의원 등 16인)</a>
                                                            </strong>
                                                        </div>
                                                        <div class="bm">
                                                            <ul>
                                                ...
                                                <li class="board_li single_link">
                                                    <div class="l">
                                                        <div class="tp">
                                                            <strong>
                                                                <span class="st font_col_yellow">정부입법예고</span><a class="subj" href="/lawpro/www/domestic/domestic0302_view.jsp">전공의의 수련환경 개선 및 지위향상을 위한 법률일부개정법률(안) 등등의 입법예고</a>
                                                            </strong>
                                                        </div>
                                                        <div class="bm">
                                                            <ul>
                                                ...
                                                <li class="board_li single_link">
                                                    <div class="l">
                                                        <div class="tp">
                                                            <strong>
                                                                <span class="st font_col_blue">의원입법예고</span><a class="subj" href="/lawpro/www/domestic/domestic0302_view.jsp">주택임대차보호법 일부계정법률안</a>
                                                            </strong>
                                                        </div>
                                                        <div class="bm">
                                                            <ul>
                                            ...
                                            <ul>
                                                <li class="board_li single_link">
                                                    <div class="l">
                                                        <div class="tp">
                                                            <strong>
                                                                <span class="st font_col_blue">의원입법예고</span><a class="subj" href="#n">주택임대차보호법 일부계정법률안</a>
                                                            </strong>
                                                        </div>
                                                        <div class="bm">
                                                            <ul>
                                                ...
                                                <li class="board_li single_link">
                                                    <div class="l">
                                                        <div class="tp">
                                                            <strong>
                                                                <span class="st font_col_yellow">정부입법예고</span><a class="subj" href="#n">주택임대차보호법 일부계정법률안</a>
                                                            </strong>
                                                        </div>
                                                        <div class="bm">
                                                            <ul>
