                        ...
                        <div class="pc_ctn">
                            ...
                            <div class="tab tab_4 legal_info">
                                <ul>
                                    ...
                                    <li class="active"><a href="/lawpro/www/knowledge/knowledge0308.jsp"><span>기타</span></a></li>
                                </ul>
                            </div>
                            <div class="tab02">
                                <ul>
                            ...
                            <div class="tbl_wrap">
                                <div class="tbl_box other_tbl">
                                    <table>
                                        <caption>국가(기타), 명칭, 사이트 정보제공</caption>
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>국제기구</td>
                                                <td>
                                                    <div class="st">Intermation Chamber of Commerce</div>
                                                   - 중재판정
                                                </td>
                                                <td>
                                                    <a href="#n" class="font_col_bk ext_link" title="새창으로 열림" target="_blank">http://www.iccsbo.org/products-and-services/arbitiration-and-adr/</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>국제기구</td>
