            ...
            <div class="inner_ctr">
                ...
                <article id="content_area">
                    ...
                    <div class="ctn">
                        ...
                        <div class="intro">
                            국내 언론 매체∙법안의 핵심이슈를 중심으로 입법현안에 대한 시사점, 주요국 입법례∙제도 등을 제공합니다.
                        </div>
                        <!-- search_form -->
                                ...
                                <ul>
                                        ...
                                        <div class="l">
                                            <div class="tp">
                                                <strong class="text_ellips02">
                                                    <span class="st font_col_blue">독일</span><a href="/lawpro/www/foreign/foreign02_view.jsp" class="subj">부모의 자녀 체벌금지  관련 독일, 일본, 뉴질랜드 입법례부모의 자녀 체벌금지  관련 독일, 일본, 뉴질랜드 입법례부모의 자녀 체벌금지  관련 독일, 일본, 뉴질랜드 입법례부모의 자녀 체벌금지  관련 독일, 일본, 뉴질랜드 입법례 지  관련 독일, 일본, 뉴질랜드 입법</a>
                                                </strong>
                                            </div>
                                            <div class="bm">
                                                <ul>
                                    ...
                                    <li class="board_li single_link">
                                        <div class="l">
                                            <div class="tp">
                                                <strong class="text_ellips02">
                                                    <span class="st font_col_blue">독일</span><a href="/lawpro/www/foreign/foreign02_view.jsp" class="subj">부모의 자녀 체벌금지  관련 독일, 일본, 뉴질랜드 입법례</a>
                                                </strong>
                                            </div>
                                            <div class="bm">
                                                <ul>
