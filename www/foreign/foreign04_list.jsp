            ...
            <div class="inner_ctr">
                ...
                <article id="content_area">
                    ...
                    <div class="ctn">
                        ...
                        <!-- // search_form -->
                        <div class="tab tab_2_7c">
                            <ul>
                                <li class="active"><a href="#n"><span>전체</span></a></li>
                                <li><a href="#n"><span>미국</span></a></li>
                                <li><a href="#n"><span>일본</span></a></li>
                                <li><a href="#n"><span>독일</span></a></li>
                                <li><a href="#n"><span>EU</span></a></li>
                                <li><a href="#n"><span>영국</span></a></li>
                                <li><a href="#n"><span>프랑스</span></a></li>
                            </ul>
                        </div>
                        <!-- 수정 -->
                        <!-- search_list -->
                                ...
                                <ul>
                                        ...
                                        <div class="l">
                                            <div class="tp">
                                                <strong class="text_ellips02">
                                                    <span class="st font_col_blue">유럽연합</span><a href="/lawpro/www/foreign/foreign04_view.jsp" class="subj">2020년 기업파산 및 지배구조법=Corporate Insolvency and Governance Act 2020</a>
                                                </strong>
                                            </div>
                                            <div class="bm">
                                                <ul>
                                                    <li>법령</li>
                                                    <li>환경노동위원회 : 2019.11.27</li>
                                    ...
                                    <li class="board_li single_link">
                                        <div class="l">
                                            <div class="tp">
                                                <strong class="text_ellips02">
                                                    <span class="st font_col_blue">호주</span><a href="/lawpro/www/foreign/foreign04_view.jsp" class="subj">중소기업 사업승계 촉진을 위한 중소기업 경영승계 원활화에 관한 법률 등 일부개정법률=中小企業の事業承継の促進のための中小企業における経営の承継の円滑化に関 중소기업 사업승계 촉진을 위한 중소기업 경영승계 원활화에 관한 법률 등 일부개정법률=中小企業の事業承継の促進のための中小企業における経営の承継の円滑化に関</a>
                                                </strong>
                                            </div>
                                            <div class="bm">
                                                <ul>
                                    ...
                                    <li class="board_li single_link">
                                        <div class="l">
                                            <div class="tp">
                                                <strong class="text_ellips02">
                                                    <span class="st font_col_blue">미국</span><a href="/lawpro/www/foreign/foreign04_view.jsp" class="subj">차량공유 앱을 통한 자가용 유상운송 알선 행위금지</a>
                                                </strong>
                                            </div>
                                            <div class="bm">
                                                <ul>
